		...
		<div class="content">
			<div class="header_conent">
				...
				<div class="form_search">
					<form action="${base }/searchAd" method="get">
						<input type="text" placeholder="Nhập từ khóa..." name="searchAdmin">
						<button>
						...
						<c:forEach items="${products}" var="product" varStatus="loop">
							<tr>
								...
								<td><a class="btn btn-primary mb-3"
									href="${base }/admin/edit-product?id=${product.id}"
									role="button">Edit <i class="fas fa-edit"></i></a>
									<button class="btn btn-danger" role="button"
										onclick="DeleteProduct(${product.id})">Delete <i class="fas fa-trash"></i></button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			$.ajax({
				...
				success : function(jsonResult) {
					if (jsonResult.code == 200) {
						...
						$("#_product_status_" + productId).html("<span class=\"badge badge-warning\"><i class=\"fas fa-times-circle\"></i></span>");
