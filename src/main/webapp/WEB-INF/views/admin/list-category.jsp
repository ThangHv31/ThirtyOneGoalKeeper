...
<body>
	<div class="main">
					...
					<tbody>
						...
						<c:forEach items="${categories}" var="categories" varStatus="loop">
							<tr>
								...
								<td><span id="_category_status_${categories.id} }">
										<c:choose>
								...
								<td><a class="btn btn-primary"
									href="${base }/admin/edit-category?id=${categories.id}"
									role="button">Edit</a>
									<button class="btn btn-danger" role="button"
										onclick="DeleteCategory(${categories.id})">Delete</button></td>
							</tr>
						</c:forEach>
					</tbody>
		...
		function DeleteCategory(categoryId) {
			...
			// $ === jQuery
			$.ajax({
				url : "/admin/delete-category?categoryId=" + categoryId,
				type : "post",
				...
				success : function(jsonResult) {
					if (jsonResult.code == 200) {
						...
						$("#_category_status_" + categoryId).html("<span class=\"badge badge-warning\">InActive</span>");
